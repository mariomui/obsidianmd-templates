...
<%* /** README 
* The nascent spec template is the goto template for most articles when the decision of a note's type is unknown. 
* [[differential-between-noteshippo-note-templates,nb.-nascent-vs-blank-no-api]]
	* #_noteshippo/differential-between/noteshippo-note-specs 
	* #_noteshippo/differential-between/noteshippo-note-templates
	* #_noteshippo/bt/≠--/noteshippo-terminology 
**/_%>
...
* # By order of recency
* v1.0.16 *2025-08-08*
	* update using [[macro-for-inserting-base-filepath,nb.-MUID-161,ver.-v0.0.9]] v0.0.8 -> v0.0.9
	* update u/ [[macro-for-inserting-local-page-tasks,nb.-MUID-147,ver.-v0.0.3]] n/a -> v0.0.3
* v1.0.15 *2025-06-07*
	* Remove dependencies
* v1.0.14 *2025-05-15*
...
* v1.0.9 *2025-01-23*
	* Add v0.0.4 of [[macro-for-insert-of-all-inlink-endpoint,uti.-inline-dql,cf.-MUID-128,nb.-MUID-150,ver.-v0.0.5]]
	* Add v0.0.2 of [[macro-for-inserting-base-filepath,nb.-MUID-161,ver.-v0.0.9]]
